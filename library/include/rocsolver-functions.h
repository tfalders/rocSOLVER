...
/*! @{
    ...
    A           pointer to type. Array on the GPU (the size depends on the value of strideA).\n
                ...
                On exit, the lower or upper triangle of the inverse A_i^{-1}
    @param[in]
    lda         rocblas_int. lda >= n.\n
                The leading dimension of matrices A_j.
    @param[in]
...
/*! @{
    \brief POTRI inverts a real symmetric (complex hermitian) positive definite matrix using
    the Cholesky factorization computed by \ref rocsolver_spotrf "POTRF".
...
/*! @{
    \brief POTRI_BATCHED inverts a batch of real symmetric (complex hermitian) positive definite
    matrices using the Cholesky factorization computed by \ref rocsolver_spotrf_batched "POTRF_BATCHED".
...
/*! @{
    \brief POTRI_STRIDED_BATCHED inverts a batch of real symmetric (complex hermitian) positive definite
    matrices using the Cholesky factorization computed by \ref rocsolver_spotrf_strided_batched "POTRF_STRIDED_BATCHED".
