        ...
        for(rocblas_int b = 0; b < bc; ++b)
        {
            ...
            for(rocblas_int i = 0; i < nb; i++)
            {
                for(rocblas_int j = 0; j < nb; j++)
                {
                    ...
                    {
                        if(i == j)
                            hB[0][b + i * bc + j * bc * ldb + k * bc * ldb * nb] += 400;
                        else
                            hB[0][b + i * bc + j * bc * ldb + k * bc * ldb * nb] -= 4;
                    }

                    for(rocblas_int k = 0; k < nblocks - 1; k++)
                    {
                        hA[0][b + i * bc + j * bc * lda + k * bc * lda * nb] -= 4;
                        hC[0][b + i * bc + j * bc * ldc + k * bc * ldc * nb] -= 4;
                    }
                }
            }
            ...
            if(singular && (b == bc / 4 || b == bc / 2 || b == bc - 1))
            {
                ...
                for(rocblas_int i = 0; i < nb; i++)
                {
                    ...
                    hB[0][b + i * bc + j * bc * ldb + k * bc * ldb * nb] = 0;
                    if(k < nblocks - 1)
                        hA[0][b + i * bc + j * bc * lda + k * bc * lda * nb] = 0;
                    if(k > 0)
                        hC[0][b + i * bc + j * bc * ldc + (k - 1) * bc * ldc * nb] = 0;
                }
        ...
        if(hInfoRes[b][0] == 0)
        {
            ...
            for(rocblas_int k = 0; k < nblocks; k++)
            {
                for(rocblas_int i = 0; i < nb; i++)
                {
                    for(rocblas_int j = 0; j < nb; j++)
                    {
                        ...
                        {
                            L[i + j * n + k * (n + 1) * nb]
                                = hBRes[0][b + i * bc + j * bc * ldb + k * bc * ldb * nb];
                            temp[i + j * nb] = 0;
                        }
                        else
                        {
                ...
                cpu_trmm(rocblas_side_left, rocblas_fill_lower, rocblas_operation_none,
                         rocblas_diagonal_unit, nb, nb, T(1), temp.data(), nb,
                         L.data() + k * (n + 1) * nb, n);
            }
            ...
            for(rocblas_int k = 0; k < nblocks; k++)
            {
                for(rocblas_int i = 0; i < nb; i++)
                {
                    if(k < nblocks - 1)
                    {
                        ...
                        {
                            U[i + (j + nb) * n + k * (n + 1) * nb]
                                = hCRes[0][b + i * bc + j * bc * ldc + k * bc * ldc * nb];
                            L[(i + nb) + j * n + k * (n + 1) * nb]
                                = hA[0][b + i * bc + j * bc * lda + k * bc * lda * nb];
                        }
                    }
            ...
            for(rocblas_int k = 0; k < nblocks; k++)
            {
                for(rocblas_int i = 0; i < nb; i++)
                {
                    ...
                    {
                        M[i + j * n + k * (n + 1) * nb]
                            = hB[0][b + i * bc + j * bc * ldb + k * bc * ldb * nb];
                        ...
                        if(k < nblocks - 1)
                        {
                            M[(i + nb) + j * n + k * (n + 1) * nb]
                                = hA[0][b + i * bc + j * bc * lda + k * bc * lda * nb];
                            M[i + (j + nb) * n + k * (n + 1) * nb]
                                = hC[0][b + i * bc + j * bc * ldc + k * bc * ldc * nb];
                        }
                    }
                }
            }
